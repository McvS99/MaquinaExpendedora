...
public class Main {
	...
	public static void main(String[] args) {
		double compra=0;
		Maquina maquinaDeMecato=new Maquina("Vending", "122312", "Mecato", 50000);
		...
		ArrayList<Producto> listaDeProductos= new ArrayList<Producto>(Arrays.asList(lays,margarita,golpe,chocolatinaJet,cheetos,deTodito,gala,wafer,doritos,margaritaLimon));
